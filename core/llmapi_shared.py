...
BM25_K1 = 1.5
BM25_B = 0.75
MIN_VECTOR_SCORE_RAW = 0.55
MIN_BM25_SCORE_RAW = 0.05
SOURCE_MIN_VECTOR_SCORE_RAW = 0.65
SOURCE_MIN_BM25_SCORE_RAW = 10.0
# Backward-compatible aliases for older call sites.
PROCEDURE_LINK_MIN_VECTOR_SCORE_RAW = SOURCE_MIN_VECTOR_SCORE_RAW
PROCEDURE_LINK_MIN_BM25_SCORE_RAW = SOURCE_MIN_BM25_SCORE_RAW
